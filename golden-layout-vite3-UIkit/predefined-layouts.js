...
const miniStackLayout  = {
    name: 'miniStack',
    config: miniStackConfig,
};

const rowWithEmptyStackConfig  = {
    root: {
        type: ItemType.row,
        content: [
            {
...
const tabDropdownLayout  = {
    name: 'tabDropdown',
    config: tabDropdownConfig,
};

const miniRowConfig_widthHeight  = {
    root: {
        type: ItemType.row,
        content: [
            {
...
const miniRowLayout_widthHeight  = {
    name: 'miniRow (WidthHeight)',
    config: miniRowConfig_widthHeight,
};

const miniStackConfig_widthHeight = {
    root: {
        type: ItemType.stack,
        content: [
            {
...
const miniStackLayout_widthHeight  = {
    name: 'miniStack (WidthHeight)',
    config: miniStackConfig_widthHeight,
};

const rowWithEmptyStackConfig_widthHeight  = {
    root: {
        type: ItemType.row,
        content: [
            {
...
const standardLayout_widthHeight  = {
    name: 'standard (WidthHeight)',
    config: standardConfig_widthHeight,
};

const responsiveConfig_widthHeight  = {
    settings: {
        responsiveMode: "always",
    },
    dimensions: {
...
const responsiveLayout_widthHeight  = {
    name: 'responsive (WidthHeight)',
    config: responsiveConfig_widthHeight,
};

const tabDropdownConfig_widthHeight  = {
    settings: {
        tabOverlapAllowance: 25,
        reorderOnTabMenuClick: false,
        tabControlOffset: 5,
...
const tabDropdownLayout_widthHeight  = {
