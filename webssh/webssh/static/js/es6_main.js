...
var waiter = document.querySelector('#waiter');
var term_type = document.querySelector('#term');
...
function parse_xterm_style() {
    var ele = document.querySelector('.xterm-helpers style');
...
function toggle_fullscreen(term) {
    var ele = document.querySelector('#terminal .terminal');
...
function ajax_complete_callback(resp) {
    //console.log("ajax_complete_callback", resp);
...
var from_id_ele = document.querySelector(form_id);
from_id_ele.addEventListener('submit', function(event) {
